...
def test_render_user_prompt_template():
    rendered = render_prompt("rag/user.md", context="ctx", question="What is the rule?")
...
def test_load_query_system_prompt():
    prompt = load_prompt("query/system.md")
    assert "search" in prompt.lower()


def test_render_query_user_prompt():
    rendered = render_prompt("query/user.md", question="What are my rights?")
